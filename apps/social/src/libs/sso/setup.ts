...
export function getSSOClient(): SSOClient {
  ...
  const config: SSOConfig = {
    ...
    appId: import.meta.env.VITE_APP_ID || import.meta.env.APP_ID || 'social',
    callbackPath: import.meta.env.VITE_SSO_CALLBACK_PATH || '/callback',
    tokenStorage:
      (import.meta.env.VITE_TOKEN_STORAGE as 'localStorage' | 'sessionStorage' | 'cookie' | 'memory') || 'localStorage',
  };
