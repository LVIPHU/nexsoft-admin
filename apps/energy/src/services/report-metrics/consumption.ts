...
import { consumptionResponseSchema, type ConsumptionResponseDto } from '@nexsoft-admin/models';
...
export async function getConsumption(params: GetConsumptionParams): Promise<ConsumptionResponseDto> {
...
export function useConsumption(
  ...
  options?: Omit<UseQueryOptions<ConsumptionResponseDto, Error, ConsumptionResponseDto>, 'queryKey' | 'queryFn'>,
) {
