...
function FormFieldSkeleton({
  ...
  return (
    <div
      className={cn('flex w-full gap-3', orientation === 'vertical' ? 'flex-col' : 'flex-row items-center', className)}
    >
      {showLabel && <Skeleton className={cn('h-4 w-24', orientation === 'horizontal' && 'flex-auto')} />}
