...
function useEventListener<
  ...
  T extends Element = TKey extends keyof HTMLElementEventMap ? HTMLDivElement : SVGElement,
>(
  eventName: TKey,
  handler: ((event: HTMLElementEventMap[TKey]) => void) | ((event: SVGElementEventMap[TKey]) => void),
...
function useEventListener<
  ...
  TKH extends keyof HTMLElementEventMap & keyof SVGElementEventMap,
  TKM extends keyof MediaQueryListEventMap,
  T extends HTMLElement | SVGAElement | MediaQueryList = HTMLElement,
>(
  eventName: TKW | TKH | TKM,
  handler: (
    event:
      | WindowEventMap[TKW]
      | HTMLElementEventMap[TKH]
      | SVGElementEventMap[TKH]
      | MediaQueryListEventMap[TKM]
      | Event,
  ) => void,
  element?: RefObject<T>,
  options?: boolean | AddEventListenerOptions,
